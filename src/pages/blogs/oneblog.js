    ...
    <>
      <li>
        <img
          ...
          ref={profileRef}
          src={comment?.owner?.profile || default_profile}
...
const OneBlog = (props) => {
  ...
  const addComment = useCallback(
    (e) => {
      ...
      axios
        .post(server + "/api/blogs/" + id + "/comments", data, {
          headers: {
        ...
        .then((res) => {
          setComments({
            ...comments,
            values: [res.data?.comment, ...comments.values],
          });
          e.target.reset();
        })
        .catch((err) => {
                ...
                <div className="blogs blog">
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: blog !== null ? blog.content : "body",
                    }}
                  ></div>
                  ...
                  >
                    <div className="info">
                      <p
                        data-info="likes"
                        className={
                          user && user !== null && likes.some(one => one.email === user?.email)
                            ? "active"
                            : ""
                        }
                        onClick={user && user !== null && likeBlog}
                      >
                        <svg
                          width=" 22"
                          height="27"
